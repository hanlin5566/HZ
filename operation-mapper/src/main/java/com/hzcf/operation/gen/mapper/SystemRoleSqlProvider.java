...
import com.hzcf.operation.gen.entity.SystemRoleExample.Criteria;
import com.hzcf.operation.gen.entity.SystemRoleExample.Criterion;
...
public class SystemRoleSqlProvider {
    ...
    public String selectByExample(SystemRoleExample example) {
        SQL sql = new SQL();
    ...
    protected void applyWhere(SQL sql, SystemRoleExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
