...
import com.hzcf.operation.gen.entity.SystemUserRoleExample.Criteria;
import com.hzcf.operation.gen.entity.SystemUserRoleExample.Criterion;
...
public class SystemUserRoleSqlProvider {
    ...
    public String selectByExample(SystemUserRoleExample example) {
        SQL sql = new SQL();
    ...
    protected void applyWhere(SQL sql, SystemUserRoleExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
