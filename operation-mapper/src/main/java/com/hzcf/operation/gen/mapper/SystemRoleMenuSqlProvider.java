...
import com.hzcf.operation.gen.entity.SystemRoleMenuExample.Criteria;
import com.hzcf.operation.gen.entity.SystemRoleMenuExample.Criterion;
import com.hzcf.operation.gen.entity.SystemRoleMenuExample;
import java.util.List;
import org.apache.ibatis.jdbc.SQL;

public class SystemRoleMenuSqlProvider {

    public String insertSelective(SystemRoleMenu record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("system_role_menu");
        ...
        if (record.getUdpateUid() != null) {
            sql.VALUES("udpate_uid", "#{udpateUid,jdbcType=INTEGER}");
        }
    ...
    public String selectByExample(SystemRoleMenuExample example) {
        SQL sql = new SQL();
        ...
        sql.SELECT("udpate_uid");
        sql.SELECT("create_time");
        sql.SELECT("update_time");
        sql.SELECT("data_status");
        sql.FROM("system_role_menu");
    ...
    public String updateByPrimaryKeySelective(SystemRoleMenu record) {
        SQL sql = new SQL();
        sql.UPDATE("system_role_menu");
        ...
        if (record.getUdpateUid() != null) {
            sql.SET("udpate_uid = #{udpateUid,jdbcType=INTEGER}");
        }
    ...
    protected void applyWhere(SQL sql, SystemRoleMenuExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
