...
import com.hzcf.operation.gen.entity.RoleModuleExample.Criteria;
import com.hzcf.operation.gen.entity.RoleModuleExample.Criterion;
import com.hzcf.operation.gen.entity.RoleModuleExample;
import java.util.List;
import org.apache.ibatis.jdbc.SQL;

public class RoleModuleSqlProvider {

    public String insertSelective(RoleModule record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("cbd_role_module");
        
        if (record.getModuleid() != null) {
            sql.VALUES("moduleId", "#{moduleid,jdbcType=VARCHAR}");
        }
        ...
        if (record.getIsdeleted() != null) {
            sql.VALUES("isDeleted", "#{isdeleted,jdbcType=CHAR}");
        }
    ...
    public String selectByExample(RoleModuleExample example) {
        SQL sql = new SQL();
        if (example != null && example.isDistinct()) {
            sql.SELECT_DISTINCT("moduleId");
        } else {
            sql.SELECT("moduleId");
        }
        sql.SELECT("roleId");
    ...
    protected void applyWhere(SQL sql, RoleModuleExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
